...
def main():
    ...
    #plt.savefig(os.path.join('figs', f'PCA_exb_only.png'), format='png', dpi=1200)
    ...
    #plot_grid(df = df, 
            ...
            #title='',
            #savefig=True,
            #filename=os.path.join('figs', f'intra_noncanon_w30.png'))
    ...
    plt.savefig(os.path.join('figs', 'canon_frequency.png'), format='png', dpi=1200)
